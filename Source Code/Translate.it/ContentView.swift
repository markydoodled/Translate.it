        ...
        TabView(selection: $tabSelection) {
            NavigationView {
                VStack {
                    GroupBox {
                    HStack {
                        Picker(selection: $languageTranslationPicker1, label: Text("Source - \(languageTranslation1)")) {
                            Group {
                        ...
                        Spacer()
                        Picker(selection: $languageTranslationPicker2, label: Text("Destination - \(languageTranslation2)")) {
                            Group {
                                Text("Afrikaans").tag(1)
                                Text("Arabic").tag(2)
                                Text("Belarusian").tag(3)
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        Button(action: {
                            ...
                            let options = TranslatorOptions(sourceLanguage: sourceLanguage, targetLanguage: destinationLanguage)
                        ...
                        .sheet(isPresented: $showingDownloading) {
                            NavigationView {
                                ProgressView()
